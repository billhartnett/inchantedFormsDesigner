...
/**
 * Represents a line with words and bounding box
 */
...
/**
 * Represents a page with its extracted content
 */
...
/**
 * Represents the complete extracted document data
 */
...
/**
 * Service for extracting text and bounding boxes from PDFs using Azure AI Document Intelligence
 */
export class DocumentIntelligenceService {
  ...
  /**
   * Extract text and bounding boxes from a PDF stored in Blob Storage
   * @param containerName Name of the blob container
   * @param blobName Name of the PDF blob
   * @returns Extracted document with text and bounding boxes
   */
  async extractFromBlob(containerName: string, blobName: string): Promise<ExtractedDocument> {
    try {
      ...
      // Call Document Intelligence API with Read OCR
  ...
  /**
   * Format the raw Document Intelligence result into our custom format
   */
   ...
   * Polygon is an array of [x, y, x, y, ...] coordinates
   */
  ...
  /**
   * Get list of all PDFs in a blob container
   */
